...
IF OBJECT_ID (N'DataWarehouse.bronze.crm_cust_info', N'U') IS NOT NULL
BEGIN
...
IF OBJECT_ID (N'DataWarehouse.bronze.crm_prd_info', N'U') IS NOT NULL
BEGIN
...
IF OBJECT_ID (N'DataWarehouse.bronze.crm_sales_details', N'U') IS NOT NULL
BEGIN
...
IF OBJECT_ID (N'DataWarehouse.bronze.erp_CUST_AZ12', N'U') IS NOT NULL
BEGIN
...
IF OBJECT_ID (N'DataWarehouse.bronze.erp_LOC_A101', N'U') IS NOT NULL
BEGIN
...
IF OBJECT_ID (N'DataWarehouse.bronze.erp_PX_CAT_G1V2', N'U') IS NOT NULL
BEGIN
